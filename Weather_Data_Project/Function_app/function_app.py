...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = 'wstreamingnamespace.servicebus.windows.net'

    #uses managed identity of fucntion app
    ...
    def get_secret_from_keyvault(vault_url, secret_name):
        ...
        retrived_secret = secret_client.get_secret(secret_name)
        return retrived_secret.value    
    ...
    def fetch_weather_data():
        ...
        #fetch api key from keyvault
        VAULT_URL = "https://weatherstreamkeyvault.vault.azure.net/"
